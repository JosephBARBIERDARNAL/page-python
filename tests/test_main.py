...
def test_compliance_result_api_rejects_invalid_bytes():
...
def test_validation_and_compliance_results_use_new_fields():
    data = minimal_pdf()
    ...
    assert isinstance(compliance, page.ComplianceResult)
    assert compliance.profile == page.ValidationProfile.PDF_A_1B
...
def test_compliance_result_exposes_profile_and_status():
    assert hasattr(page, "ComplianceResult")
